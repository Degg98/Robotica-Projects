...
% accessibilità considerando solo il secondo ingresso
Delta0 = simplify([g2]);
Delta = simplify([f g2]);
...
for i=1:size(Delta0,2)
    ...
    D12(:,i) = LieBrackets(Delta0(:,i), g2, x);
end
...
for i=1:size(Delta1,2)
    ...
    D22(:,i) = LieBrackets(Delta1(:,i), g2, x);
end
...
fprintf('Il sistema non è accessibile dal secondo ingresso (tau)\n')